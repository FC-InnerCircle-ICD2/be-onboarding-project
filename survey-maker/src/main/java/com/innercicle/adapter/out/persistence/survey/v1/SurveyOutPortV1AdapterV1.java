...
public class SurveyOutPortV1AdapterV1 implements RegisterSurveyOutPortV1, ModifySurveyOutPortV1, SearchSurveyOutPortV1 {
    ...
    public Survey searchSurvey(SearchSurveyQueryV1 searchSurveyQueryV1) {
        return surveyRepository.findById(searchSurveyQueryV1.getSurveyId())
